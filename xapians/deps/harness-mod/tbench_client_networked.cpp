...
//std::string pid_file = getOpt<std::string>("TBENCH_CPID","/lustre1/work/rajivni/2019/benchmarks/pid.txt");
//FILE* filePthreads = fopen(pid_file.c_str(), "w");
