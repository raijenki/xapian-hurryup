...
do
	...
	do
	cat /sys/devices/system/cpu/cpu0/cpufreq/stats/time_in_state > /home/cc/hurryup-dvfs/raw-results/time_in_state/tis-hup-gov@varFreq-${counter}-${queryPerSecond}-sleep1000-start.txt
	...
	cat /sys/devices/system/cpu/cpu0/cpufreq/stats/time_in_state > /home/cc/hurryup-dvfs/raw-results/time_in_state/tis-hup-gov@varFreq-${counter}-${queryPerSecond}-sleep1000-end.txt
